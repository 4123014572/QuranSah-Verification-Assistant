                              ...
                              for (var i = 0; i < tipuesearch_in.pages.length; i++)
                              {
                                   ...
                                   for (var f = 0; f < d_w.length; f++)
                                   {
                                        ...
                                        if (set.highlightTerms)
                                        {
                                             ...
                                             s_t = s_t.replace(patr, "<highlight>$1</highlight>");
                                        }
                                   ...
                                   {                                   
                                        ...
                                        {                                        
                                             ...
                                             else
                                             {
                                                  //coisox
                                                  //==================================================
                                                  var csx_loc = t.indexOf('<highlight>');
                                                  var csx_leading = t.substring(0, csx_loc).split(' ');
                                                  var csx_start = csx_leading.length - 4;
                                                  if (csx_leading.length<4) csx_start = 0;
                                                  //==================================================
                                                  for (var f = csx_start; f < set.descriptiveWords+csx_start; f++)
                                                  {
                                                      if(t_w[f]) t_d += t_w[f] + ' ';
                                                  }
                                             }
